...
LeggedStateEstimatorSettings LeggedStateEstimatorSettings::UnitreeA1(const std::string &urdf_path,
...
LeggedStateEstimatorSettings LeggedStateEstimatorSettings::AnymalD(const std::string &urdf_path,
                                                                          const double sampling_time) {
    LeggedStateEstimatorSettings settings;
    settings.urdf_path = urdf_path;
    settings.imu_frame = "base";
    settings.contact_frames = {"LF_FOOT", "RF_FOOT", "LH_FOOT", "RH_FOOT"};
    ...
    settings.inekf_noise_params.setGyroscopeNoise(0.11);
    settings.inekf_noise_params.setAccelerometerNoise(0.1);
    settings.inekf_noise_params.setGyroscopeBiasNoise(0.21);
    settings.inekf_noise_params.setAccelerometerBiasNoise(0.21);
    settings.inekf_noise_params.setContactNoise(0.1);
